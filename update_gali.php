...
$dbname = "sattaopen";
$id=$_GET['id'];
$gali_number=$_POST['gali_number'];
$gali_date=$_POST['gali_date'];
$conn = mysqli_connect($servername, $username, $password, $dbname);
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE gali SET gali_number='$gali_number', gali_date='$gali_date'   WHERE id='$id' ");
...
$result = mysqli_query($conn,"SELECT * FROM gali WHERE id='" . $_GET['id'] . "'");
...
<input type="text" name="gali_number"  class="form-control" value="<?php echo $row['gali_number']; ?>"> 
<br>
<span style="font-size:20px; font-weight:bold;" >Date:</span><br>
<input type="text" name="gali_date"  class="form-control" value="<?php echo $row['gali_date']; ?>">
<br>
<input type="submit" name="submit" value="Update" class="buttom">

<br><br><br><br>
<a href="gali.php"> Click Here To Back</a>
</form>
</div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
</div>
