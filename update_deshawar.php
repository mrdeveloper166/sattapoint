...
$dbname = "sattaopen";
$id=$_GET['id'];
$desawar_number=$_POST['desawar_number'];
$desawar_date=$_POST['desawar_date'];
$conn = mysqli_connect($servername, $username, $password, $dbname);
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE desawar SET desawar_number='$desawar_number', desawar_date='$desawar_date'   WHERE id='$id' ");
...
$result = mysqli_query($conn,"SELECT * FROM desawar WHERE id='" . $_GET['id'] . "'");
...
<input type="text" name="desawar_number"  class="form-control" value="<?php echo $row['desawar_number']; ?>"> 
<br>
<span style="font-size:20px; font-weight:bold;" >Date:</span><br>
<input type="text" name="desawar_date"  class="form-control" value="<?php echo $row['desawar_date']; ?>">
<br>
<input type="submit" name="submit" value="Update" class="buttom">

<br><br><br><br>
<a href="desawar.php"> Click Here To Back</a>
</form>
</div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
</div>
