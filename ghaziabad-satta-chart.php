...
<head>
    ...
    <meta charset="UTF-8">
    <title>Welcome To Ghaziabad</title>
...
?>
	...
	<h2 style="background-color:Green; color:white;"> Ghaziabad Satta Game 2020 Chart  </h2>
	<div class=" table-responsive  col-lg-12 col-md-12 col-sm-12 col-xs-12" >
     <table class="table table-dark" border="2" width="100%" style="font-size:25px; color:white;">
          <tr>
              <th>Serial Number</th>
			  <th>Ghaziabad Game</th>
              <th>Date</th>
...
$sql = "SELECT * FROM ghaziabad ORDER BY id ASC";
