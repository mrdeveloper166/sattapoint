...
$dbname = "sattaopen";
$id=$_GET['id'];
$num_name=$_POST['num_name'];
$date=$_POST['date'];
$conn = mysqli_connect($servername, $username, $password, $dbname);
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE numbers SET num_name='$num_name', date='$date'   WHERE id='$id' ");
...
$result = mysqli_query($conn,"SELECT * FROM numbers WHERE id='" . $_GET['id'] . "'");
...
<input type="text" name="num_name"  class="form-control" value="<?php echo $row['num_name']; ?>"> 
<br>
...
<br><br><br><br>
<a href="welcome.php"> Click Here To Back</a>
</form>
</div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
</div>
