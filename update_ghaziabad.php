...
$dbname = "sattaopen";
$id=$_GET['id'];
$ghaziabad_number=$_POST['ghaziabad_number'];
$ghaziabad_date=$_POST['ghaziabad_date'];
$conn = mysqli_connect($servername, $username, $password, $dbname);
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE ghaziabad SET ghaziabad_number='$ghaziabad_number', ghaziabad_date='$ghaziabad_date'   WHERE id='$id' ");
...
$result = mysqli_query($conn,"SELECT * FROM ghaziabad WHERE id='" . $_GET['id'] . "'");
...
<input type="text" name="ghaziabad_number"  class="form-control" value="<?php echo $row['ghaziabad_number']; ?>"> 
<br>
<span style="font-size:20px; font-weight:bold;" >Date:</span><br>
<input type="text" name="ghaziabad_date"  class="form-control" value="<?php echo $row['ghaziabad_date']; ?>">
<br>
<input type="submit" name="submit" value="Update" class="buttom">

<br><br><br><br>
<a href="ghaziabad.php"> Click Here To Back</a>
</form>
</div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
</div>
