...
<head>
    ...
    <meta charset="UTF-8">
    <title>Welcome To Faridabad Satta</title>
...
?>
	...
	<h2 style="background-color:Green; color:white;"> Faridabad Satta Game 2020 Chart  </h2>
...
$sql = "SELECT * FROM faridabad ORDER BY id ASC";
