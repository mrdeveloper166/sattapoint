...
$dbname = "sattaopen";
$id=$_GET['id'];
$devbhumi_number=$_POST['devbhumi_number'];
$devbhumi_date=$_POST['devbhumi_date'];
$conn = mysqli_connect($servername, $username, $password, $dbname);
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE devbhumi SET devbhumi_number='$devbhumi_number', devbhumi_date='$devbhumi_date'   WHERE id='$id' ");
...
$result = mysqli_query($conn,"SELECT * FROM devbhumi WHERE id='" . $_GET['id'] . "'");
...
<input type="text" name="devbhumi_number"  class="form-control" value="<?php echo $row['devbhumi_number']; ?>"> 
<br>
<span style="font-size:20px; font-weight:bold;" >Date:</span><br>
<input type="text" name="devbhumi_date"  class="form-control" value="<?php echo $row['devbhumi_date']; ?>">
<br>
<input type="submit" name="submit" value="Update" class="buttom">

<br><br><br><br>
<a href="devbhumi.php"> Click Here To Back</a>
</form>
</div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
</div>
